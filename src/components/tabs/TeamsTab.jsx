...
export const TeamsTab = ({ eliminatedTeams, isViewer, assignments, members, handleAssign, toggleEliminated }) => {
  const [managerFilter, setManagerFilter] = useState(() => {
    try { return localStorage.getItem('worldCupTeamsFilter') || 'All'; } catch { return 'All'; }
  });
