      ...
      <div className={`grid grid-cols-1 ${settings.kidAwards ? 'md:grid-cols-2' : ''} gap-6`}>
        <div className="bg-white rounded-xl shadow-md border-2 border-green-100 overflow-hidden flex flex-col">
          ...
          <div className="p-4 space-y-4 flex-1 flex flex-col justify-center">
            ...
            />
            <AwardRow rank="2nd" member={awards.overall['2nd']} icon={<img src="/standings/second.svg" alt="Wooden Spoon" className="w-6 h-6 drop-shadow-sm shrink-0" />} 
                hideRankText={true}
            <AwardRow rank="3rd" member={awards.overall['3rd']} icon={<img src="/standings/third.svg" alt="Wooden Spoon" className="w-6 h-6 drop-shadow-sm shrink-0" />} 
                hideRankText={true}
