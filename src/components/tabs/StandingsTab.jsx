    ...
    try {
      ...
      const rows = memberStats.map((m, idx) => {
        ...
        const teamBadges = activeTeams.map(t =>
          `<span style="display:inline-block;background:#dcfce7;color:#166534;border:1px solid #bbf7d0;border-radius:4px;padding:4px 7px 6px 7px;font-size:11px;font-weight:700;margin:2px 2px 2px 0;line-height:1;vertical-align:middle;">${t.id}</span>`
