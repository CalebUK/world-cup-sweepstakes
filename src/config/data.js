export const TEAMS_DATA = [
  ...
  { id: 'USA', name: 'USA', espnName: 'United States', group: 'D', rank: 16 },
  ...
  { id: 'CIV', name: "Côte d'Ivoire", espnName: 'Ivory Coast', group: 'E', rank: 34 },
  ...
  { id: 'IRN', name: 'IR Iran', espnName: 'Iran', group: 'G', rank: 21 },
  { id: 'NZL', name: 'New Zealand', group: 'G', rank: 85 },
  { id: 'CPV', name: 'Cabo Verde', espnName: 'Cape Verde', group: 'H', rank: 69 },
  ...
  { id: 'COD', name: 'Congo DR', espnName: 'DR Congo', group: 'K', rank: 46 },
